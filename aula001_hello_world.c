#include<stdio.h> /* biblioteca de leitura e escrita do programa 
(escrever na tela e ler no teclado, por exemplo) */
...
int main(){ //este é o corpo do programa (todos utilizam este comando)
    ...
    system("pause"); /* é preciso colocar a biblioteca #include<stdlib.h> e o comando de system("pause") 
    para que o programa faça uma pausa depois de ser executado */
    return 0; 
}
